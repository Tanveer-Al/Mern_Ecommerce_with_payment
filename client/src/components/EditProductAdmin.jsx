...
const EditProductAdmin = ({ close ,data : propsData,fetchProductData}) => {
  const [data, setData] = useState({
    _id: propsData._id || '',
    name: propsData.name || '',
    image: Array.isArray(propsData.image) ? propsData.image : [],
    category: Array.isArray(propsData.category) ? propsData.category : [],
    subCategory: Array.isArray(propsData.subCategory) ? propsData.subCategory : [],
    unit: propsData.unit || '',
  ...
  // Update state if propsData changes
  useEffect(() => {
    setData({
      _id: propsData._id || '',
      name: propsData.name || '',
            ...
            <form className='grid gap-4' onSubmit={handleSubmit}>
              ...
              {/**add more field**/}
              {
                Object?.keys(data?.more_details || {})?.map((k, index) => {
                  return (
                    <div className='grid gap-1' key={k + index + 'morefield'}>
